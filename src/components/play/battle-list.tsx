                    ...
                    <CardContent className="p-2 flex items-center justify-between">
                        ...
                        <Avatar className="h-8 w-8 flex-shrink-0">
                         ...
                         <div className="flex-grow overflow-hidden">
                            <div className="flex items-center gap-1">
                                <span className="font-semibold truncate text-sm">{battle.player1.displayName}</span>
                                {battle.player1.isKycVerified && <ShieldCheck className="h-3 w-3 text-blue-500 flex-shrink-0" />}
                            </div>
                        </div>
                        </div>

                        <div className="text-center basis-1/5">
                            <p className="font-bold text-red-600 font-sans text-sm">₹{battle.amount}</p>
                            <Image src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEilS2_YhPAJBDjdcIRsoMJLTWafsJuIyola3KN50zXQAZYWSSIbhLhWhOJGMG6UYkUB5ZOiVKgsy2bVstr2af0LVf2g-eWjXHnGO4Z0IbaePP4E7TSDB9x_eK8OqTidX968zc5Wn9p6uGlkLoD9iglU3KZ28_2IbXgl29zHTZgwxzMWPvbN6zhA5AhyH7s/s1600/74920.png" alt="vs" width={24} height={12} className="mx-auto" data-ai-hint="versus icon" />
                        </div>
                        ...
                        <div className="flex-grow overflow-hidden text-right">
                             <div className="flex items-center justify-end gap-1">
                                <span className="font-semibold truncate text-sm">{battle.player2.displayName}</span>
                                {battle.player2.isKycVerified && <ShieldCheck className="h-3 w-3 text-blue-500 flex-shrink-0" />}
                            </div>
                        </div>
                        <Avatar className="h-8 w-8 flex-shrink-0">
