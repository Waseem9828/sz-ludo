...
const allNavItems = [
    ...
    { href: "/admin/agents", icon: Briefcase, label: "Agents", roles: ['superadmin', 'finance'] },
...
export default function AdminLayout({
  ...
  if (!isClient || loading || !user || !appUser) {
    return <SplashScreen />;
  }
  
  if (!appUser.role || !['superadmin', 'finance', 'support'].includes(appUser.role)) {
    return (
