        ...
        <div className="flex flex-col min-h-screen bg-background font-body">
            ...
            <main className="flex-grow container mx-auto px-4 py-6 space-y-6">
                <div className="bg-card p-6 md:p-8 rounded-lg shadow-md">
                    <h1 className="text-3xl font-bold mb-6 font-headline text-center">GST Policy</h1>
                    ...
                    <div className="space-y-6 text-foreground">
                        ...
                        <div>
                            <h2 className="text-xl font-bold font-headline mb-3">GST Registration</h2>
                        ...
                        <div>
                            <h2 className="text-xl font-bold font-headline mb-3">GST on Transactions</h2>
                        ...
                        <div>
                            <h2 className="text-xl font-bold font-headline mb-3">Tax Invoices</h2>
                        ...
                        <div>
                            <h2 className="text-xl font-bold font-headline mb-3">GST Refunds</h2>
