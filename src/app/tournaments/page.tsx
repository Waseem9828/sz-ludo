        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
            <div className="flex-shrink-0 w-full lg:w-[420px]">
                <div className="w-full h-[250px] rounded-xl relative overflow-hidden group">
                    <Image src={tournament.imageUrl || "https://placehold.co/400x300.png"} alt={tournament.title} fill sizes="(max-width: 1024px) 100vw, 420px" className="object-cover transition-transform duration-700 ease-in-out group-hover:scale-105" data-ai-hint="game tournament"/>
